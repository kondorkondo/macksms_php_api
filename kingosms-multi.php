...
<head>
    ...
    <title>Multi - Bulk SMS Sender</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Multi - Bulk SMS Sender</h1>
        
        <form id="smsForm" action="kingosms-multi.php" method="POST">
            <div class="form-group">
                <label for="recipients">Recipients:</label>
                <textarea id="recipientList" name="recepients" placeholder="Enter phone number starting by 0 i.e 0712345678, separate by comma (,)" required></textarea>
            </div>
            ...
            <div class="form-group">
                <button type="submit" name="send_multi_sms">Send SMS</button>
            </div>
        </form>
